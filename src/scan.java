...
public class scan {
	...
	public static void main(String[] args) throws SQLException, IOException {
		...
		Workbook data;
		 ...
		 ResultSet rs;
		 rs = mystatement.executeQuery("CREATE TABLE SERVICES(NOM VARCHAR(20), NUMERO int IDENTITY(1,1) PRIMARY KEY, INTERIEUR BOOLEAN)");
		 rs = mystatement.executeQuery("CREATE TABLE MEDECINS(NUMERO int IDENTITY(1,1) PRIMARY KEY, NOM VARCHAR(20), DERNIEREGARDE DATE, NBGARDES INTEGER, NBLUNDI INTEGER, NBMARDI INTEGER, NBMERCREDI INTEGER, NBJEUDI  INTEGER, NBVENDREDI INTEGER, NBSAMEDI INTEGER, NBDIMANCHE INTEGER, FOREIGN KEY (SERVICE) REFERENCEs SERVICE(NUMERO), NBSEMESTRES INTEGER, NBFERIES INTEGER");
